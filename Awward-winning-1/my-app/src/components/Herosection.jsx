    ...
    return(
        ...
        className="py-20 min-h-screen w-full bg-[#ffd900] flex flex-col lg:flex-row">
            <div className="py-2 px-6 sm:px-10 w-full lg:w-3/4">
                ...
                <div className="para text-base sm:text-lg lg:text-2xl mt-8 lg:mt-14">
                    <p>
                        ...
                        brands that stop traffic, spark conversations, <br />
                        and turn eavery space into a landmark.
                    </p>
                </div>
                <div className="nav3 flex flex-wrap mt-8 lg:mt-10 gap-4">
                    ...
                    <h4 className="font-semibold px-4 py-3 border uppercase rounded-[5px] border-black text-sm sm:text-base">
                        see our work
                    </h4>
                </div>
            </div>
            ...
            <div className="relative w-full lg:w-[25vw] mt-12 lg:mt-0 flex justify-center">
                <div className="absolute lg:top-96 w-[70vw] sm:w-[50vw] lg:w-full h-[40vw] sm:h-[30vw] lg:h-[15vw] bg-red-700 overflow-hidden rounded-lg mr-4">
                    <video src="/e22379bd.mp4" autoPlay loop muted playsInline className="w-full h-full object-cover"></video>
                </div>
                <h3 className="nav3 absolute font-semibold top-[calc(2rem+40vw)] sm:top-[calc(2rem+30vw)] lg:top-[calc(2rem+40vw)] mt-4">
                   Showreel (2023 - 2025)
                </h3>
            </div>
        </div>
